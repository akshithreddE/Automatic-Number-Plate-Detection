...
class SpeedEstimator(BaseSolution):
    ...
    def estimate_speed(self, im0):
       ...
       # self.annotator.draw_region(
        #    reg_pts=self.region, color=(104, 0, 123), thickness=self.line_width) #Draw region
...
# Open the video file
video_path = ("mycarplate")  # Change this to the correct absolute path
...
if not cap.isOpened():
    ...
    if cap.isOpened():
        print("Success with FFMPEG backend!")
    else:
        print("All attempts failed. Check video format or path.")
        exit()

else:
    print(f"Success: Video file '{video_path}' opened!")
